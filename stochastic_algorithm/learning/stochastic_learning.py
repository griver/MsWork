...
import numpy as np
from fslib import EnvBuilder
from stochastic_algorithm.learning.secondary_logger import SecondaryLogger
from stochastic_algorithm.learning.secondary_logger import TrialActionInfo
...
def calc_action_value_function(logger, vf, net, alpha, reward=1.0, penalty=0.0):
    """
...
def update_weights(net, av, min_weight=0.98):
    """
