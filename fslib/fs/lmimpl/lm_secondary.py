...
class LMSecondary(BaseSecondary):
    def __init__(self, env, motivation, prev_st, goal_st, calc_IA, calc_AR, calc_ii, delta_si):
        BaseSecondary.__init__(self, "Secondary: " + prev_st.name + " -> " + goal_st.name, active_threshold=0.97)
